        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    @php
                        $cartQuantity = $cartItemCount ?? 0;
                    @endphp


                    <a href="{{ route('cart.index') }}"
                       class="relative inline-flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition">
                        My Cart
                        @if($cartQuantity > 0)
                            <span
                        ...
                        @else
                            <span
                                class="ml-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-gray-400 bg-gray-300 rounded-full">
                                0
                            </span>
                        @endif
                    </a>
