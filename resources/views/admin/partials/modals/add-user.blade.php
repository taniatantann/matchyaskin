<div id="addUserModal" class="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm hidden items-center justify-center px-4">
    <div class="bg-white w-full max-w-md rounded-2xl p-6 shadow-lg animate-fade-in relative">
        ...
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Add User</h2>
        <form method="POST" action="{{ route('admin.addUser') }}" class="space-y-4">
            @csrf
            <div>
