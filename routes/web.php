...
Route::get('/dashboard', function () {
    ...
    if ($role === 'customer') return redirect('/'); // atau route('user.welcome') kalo pakai controller
})->name('dashboard');
...
// ==================== USER ====================
Route::middleware(['auth', 'role:customer'])->prefix('user')->group(function () {
    ...
    Route::post('/cart/increase/{itemId}', [CartController::class, 'increaseQty'])->name('cart.increase');
    Route::post('/cart/decrease/{itemId}', [CartController::class, 'decreaseQty'])->name('cart.decrease');
...
Route::middleware(['auth', 'role:seller'])->prefix('seller')->group(function () {
    ...
    Route::post('/manage-order/deny/{order}', [TransactionController::class, 'denyOrder'])->name('seller.orders.deny');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/ingredient-recommendations', [RecommendationController::class, 'getIngredientRecommendations'])->name('ingredient.recommendations');
});
